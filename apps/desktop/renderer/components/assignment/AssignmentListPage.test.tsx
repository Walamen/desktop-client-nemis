...
// Classes, and Attendance pages (see their test files). This mock's `staff`
...
function installBaseMock() {
  (window as unknown as { nemis: unknown }).nemis = {
    ...
    assignment: {
      list: vi.fn(async () => [
        { id: 'asg-1', classId: 'class-1', className: 'Grade 10A', subjectId: 'sub-1', subjectName: 'Mathematics', teacherId: STAFF_ID, title: 'Chapter 5', type: 'HOMEWORK', status: 'ACTIVE', dueDate: '2026-09-01', totalMarks: 100, submittedCount: 0, totalStudents: 0, createdAt: '2026-01-01T00:00:00.000Z', updatedAt: '2026-01-01T00:00:00.000Z' },
      ]),
    },
    schoolAdmin: {
